...
2. **Finish the public materials.** Use `store/LISTING.md` as your listing draft. The completed privacy policy is published at https://github.com/camwooloo/streamshade/blob/main/store/PRIVACY.md; use that URL in the dashboard. It names camwooloo as publisher and links to the public GitHub support page.
